...
import { LayoutDashboard, Users, CalendarDays, Dumbbell, Inbox, CreditCard, LogOut, Home } from "lucide-react";
    ...
    <div className="min-h-screen bg-secondary/20 flex">
      <aside className="hidden md:flex flex-col w-64 bg-primary text-primary-foreground fixed inset-y-0 left-0 z-30">
        <div className="px-6 py-8">
          <Link to="/admin" className="font-heading text-xl font-bold tracking-tight">ELAN</Link>
      ...
      <div className="flex-1 md:ml-64">
        <header className="md:hidden sticky top-0 z-20 glass-nav px-6 py-4 flex items-center justify-between">
          <Link to="/admin" className="font-heading text-lg font-bold text-primary-foreground">ELAN</Link>
