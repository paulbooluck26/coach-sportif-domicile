...
const OFFRES = [
  {
    ...
    lien: "/espace-client/reserver/domicile",
    icon: Home,
  ...
  },
  {
    ...
    lien: "/espace-client/reserver/programme",
    icon: Dumbbell,
    image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80",
  },
  {
    titre: "Appel découverte",
    description: "Un échange gratuit pour discuter de votre projet et définir l'accompagnement adapté.",
    bouton: "Réserver un appel gratuit",
    lien: "/espace-client/reserver/appel",
    icon: PhoneCall,
