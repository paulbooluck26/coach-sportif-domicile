  ...
  return (
    <div className="fixed inset-0 z-50 bg-primary text-primary-foreground flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-10">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-secondary mb-4">Nouveau bloc</p>
        <h1 className="font-heading text-5xl md:text-6xl font-bold text-center mb-6">{bloc?.titre}</h1>
        {totalRounds > 1 && <p className="text-primary-foreground/60 mb-8">Ce bloc comporte {totalRounds} tours</p>}
